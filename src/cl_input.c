...
CVAR_REGISTER(cl_upspeed, CVAR_CTOR({ "cl_upspeed", 200 }));
CVAR_REGISTER(cl_forwardspeed, CVAR_CTOR({ "cl_forwardspeed", 200, true }));
CVAR_REGISTER(cl_backspeed, CVAR_CTOR({ "cl_backspeed", 200, true }));
CVAR_REGISTER(cl_sidespeed, CVAR_CTOR({ "cl_sidespeed", 350 }));

CVAR_REGISTER(cl_movespeedkey, CVAR_CTOR({ "cl_movespeedkey", 2.0 }));

CVAR_REGISTER(cl_yawspeed, CVAR_CTOR({ "cl_yawspeed", 140 }));
CVAR_REGISTER(cl_pitchspeed, CVAR_CTOR({ "cl_pitchspeed", 150 }));

CVAR_REGISTER(cl_anglespeedkey, CVAR_CTOR({ "cl_anglespeedkey", 1.5 }));
