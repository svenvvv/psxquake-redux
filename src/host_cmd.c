...
CMD_REGISTER("status", Host_Status_f);
CMD_REGISTER("quit", Host_Quit_f);
CMD_REGISTER("god", Host_God_f);
CMD_REGISTER("notarget", Host_Notarget_f);
CMD_REGISTER("fly", Host_Fly_f);
CMD_REGISTER("map", Host_Map_f);
CMD_REGISTER("restart", Host_Restart_f);
CMD_REGISTER("changelevel", Host_Changelevel_f);
#ifdef QUAKE2
CMD_REGISTER("changelevel2", Host_Changelevel2_f);
#endif
CMD_REGISTER("connect", Host_Connect_f);
CMD_REGISTER("reconnect", Host_Reconnect_f);
CMD_REGISTER("name", Host_Name_f);
CMD_REGISTER("noclip", Host_Noclip_f);
CMD_REGISTER("version", Host_Version_f);
#ifdef IDGODS
CMD_REGISTER("please", Host_Please_f);
#endif
CMD_REGISTER("say", Host_Say_f);
CMD_REGISTER("say_team", Host_Say_Team_f);
CMD_REGISTER("tell", Host_Tell_f);
CMD_REGISTER("color", Host_Color_f);
CMD_REGISTER("kill", Host_Kill_f);
CMD_REGISTER("pause", Host_Pause_f);
CMD_REGISTER("spawn", Host_Spawn_f);
CMD_REGISTER("begin", Host_Begin_f);
CMD_REGISTER("prespawn", Host_PreSpawn_f);
CMD_REGISTER("kick", Host_Kick_f);
CMD_REGISTER("ping", Host_Ping_f);
CMD_REGISTER("load", Host_Loadgame_f);
CMD_REGISTER("save", Host_Savegame_f);
CMD_REGISTER("give", Host_Give_f);

CMD_REGISTER("startdemos", Host_Startdemos_f);
CMD_REGISTER("demos", Host_Demos_f);
CMD_REGISTER("stopdemo", Host_Stopdemo_f);

CMD_REGISTER("viewmodel", Host_Viewmodel_f);
CMD_REGISTER("viewframe", Host_Viewframe_f);
CMD_REGISTER("viewnext", Host_Viewnext_f);
CMD_REGISTER("viewprev", Host_Viewprev_f);

CMD_REGISTER("mcache", Mod_Print);
